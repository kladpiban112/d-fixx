    ...
    <div class="card-header ribbon ribbon-right">
        ...
        <div class="card-toolbar">
            <div class="example-tools justify-content-center">
                <a href="dashboard.php?module=<?php echo $module;?>&page=staff"
                ...
                <div class="col-lg-9">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" placeholder="เลขบัตรประชาชน 13 หลัก" name="scid"
                                id="scid" maxlength="13" value="<?php echo $row_person['scid'];?>" />
					...
					while ($row = $stmt_user_role->fetch(PDO::FETCH_ASSOC))
						...
						?>
                                <option value="<?php echo $id_selected;?>"
                                    <?php if($row_person['org_id'] == $id_selected ){echo "selected";} ?>>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-5">
                            <label>ชื่อ</label>
                            <input type="text" class="form-control" name="sfname" id="sfname" placeholder="ชื่อ"
                                value="<?php echo $row_person['sfname'];?>" />

                        </div>
                        <div class="col-lg-5">
                            <label>สกุล</label>
                            <input type="text" class="form-control" name="slname" id="slname" placeholder="สกุล"
                                value="<?php echo $row_person['slname'];?>" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="text" class="form-control" name="nickname" id="nickname" placeholder="ชื่อเล่น"
                                value="<?php echo $row_person['nickname'];?>" />
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" name="stelephone" id="stelephone"
                                placeholder="โทรศัพท์" value="<?php echo $row_person['stelephone'];?>" maxlength="10" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="text" class="form-control" name="startdate" id="startdate"
                                ...
                                value="<?php echo date_db_2form($row_person['startdate']);?>" data-date-language="th-th"
                                maxlength="10" />
                        </div>
                        ...
                        <div class="col-lg-2">
                            ...
                            <select class="form-control " name="flag" id="flag">
                                <option value="">ระบุ</option>
                                <option value="1" <?php if($row_person['flag'] == '1' ){echo "selected";} ?>>ปฏิบัติงาน
                                </option>
                                <option value="2" <?php if($row_person['flag'] == '2' ){echo "selected";} ?>>ลาออก
                                </option>
                                <option value="0" <?php if($row_person['flag'] == '0' ){echo "selected";} ?>>ลบข้อมูล
                                </option>
                            </select>
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="text" class="form-control" name="outdate" id="outdate"
                                placeholder="วันที่สิ้นสุดทำงาน"
                                value="<?php echo date_db_2form($row_person['outdate']);?>" data-date-language="th-th"
                                maxlength="10" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <textarea class="form-control" name="out_desc"
                                id="out_desc"><?php echo $row_person['out_desc'];?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-3">
                            ...
                            <input type="text" class="form-control" name="house" id="house" placeholder="บ้านเลขที่"
                                value="<?php echo $row_person['house'];?>" />
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="text" class="form-control" name="road" id="road" placeholder="ถนน"
                                value="<?php echo $row_person['road'];?>" />
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <input type="file" class="form-control" name="img_profile" id="img_profile"
                                placeholder="รูปถ่ายผู้รับบริการ" />
